...
/**
 * A block representing the metal furnace
 */
class MetalFurnaceBlock(settings: Settings) : Block(settings), BlockEntityProvider {
    companion object {
        // 1 empty sealed container slot
        // 1 resulting sealed container slot
        // 1 input slot
        // 1 failed sealed container slot
        // 1 fuel slot
    ...
    override fun <T : BlockEntity?> getTicker(
        ...
        return BlockEntityTicker { world0, blockPos, blockState, blockEntity ->
            MetalFurnaceBlockEntity.tick(world0, blockPos, blockState, blockEntity as MetalFurnaceBlockEntity)
        }
    }
